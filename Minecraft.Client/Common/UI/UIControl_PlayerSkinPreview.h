...
public:
	...
	void renderScreenRect(float x, float y, float width, float height);
	...
	void SetRotation(int xRot, int yRot);
	void SetStandingPose(bool standing);
